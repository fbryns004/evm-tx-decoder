...
<p align="center">
  <sub>calldata · approvals · logs</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>TxDecoder</code> &nbsp;·&nbsp; <code>txdecode</code>
</p>
...
EVM transaction decoder — human-readable calldata, token transfers, approval warnings.

Security people search evm-tx-decoder before signing unknown contracts.
...
```bash
dotnet restore evm-tx-decoder.slnx
dotnet build evm-tx-decoder.slnx -c Release
dotnet test evm-tx-decoder.slnx -c Release
```
